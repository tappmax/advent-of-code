...
import { getDirectorySum, getHydratedDirectoryMap, getIO, stringToCmdIO } from '../functions';
...
describe(`Test`, () => {
  ...
  describe(`Directory summages`, () => {
    ...
    it(`shouldn't sum them if it exceeds threshold`, () => {
      expect(95437).to.equal(getDirectorySum(directoryMap));
    });
  });
});
